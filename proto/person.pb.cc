...
const ::uint32_t
    TableStruct_person_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::sockets::Person, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::sockets::Person, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::sockets::Person, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::sockets::Person, _impl_.id_),
        PROTOBUF_FIELD_OFFSET(::sockets::Person, _impl_.email_),
        0,
        2,
        1,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 11, -1, sizeof(::sockets::Person)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::sockets::_Person_default_instance_._instance,
};
const char descriptor_table_protodef_person_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\014person.proto\022\007sockets\"Z\n\006Person\022\021\n\004nam"
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:sockets.Person)
}
inline PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::sockets::Person& from_msg)
...
Person::Person(
  ...
  // @@protoc_insertion_point(copy_constructor:sockets.Person)
}
inline PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:sockets.Person)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<2, 3, 0, 32, 2> Person::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::sockets::Person>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:sockets.Person)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Person::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:sockets.Person)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (cached_has_bits & 0x00000001u) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "sockets.Person.name");
          ...
          if (cached_has_bits & 0x00000002u) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "sockets.Person.email");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:sockets.Person)
          return target;
        }
        ...
        ::size_t Person::ByteSizeLong() const {
          const Person& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:sockets.Person)
          ::size_t total_size = 0;
...
void Person::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:sockets.Person)
...
// @@protoc_insertion_point(class_specific_copy_from_start:sockets.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
