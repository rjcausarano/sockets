...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> Header_Type_strings[2] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry Header_Type_entries[] = {
  { {Header_Type_names + 0, 6}, 1 },
  { {Header_Type_names + 6, 4}, 0 },
};
...
bool Header_Type_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      Header_Type_entries, 2, name, &int_value);
  if (success) {
