...
extern const ::google::protobuf::internal::ClassDataLite<7> Header_class_data_;
namespace google {
namespace protobuf {
}  // namespace protobuf
}  // namespace google
...
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Header::set_data(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.data_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:Header.data)
}
inline std::string* PROTOBUF_NONNULL Header::mutable_data()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL Header::_internal_mutable_data() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.data_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE Header::release_data() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void Header::set_allocated_data(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
