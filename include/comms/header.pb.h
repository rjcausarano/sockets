...
#ifndef GOOGLE_PROTOBUF_INCLUDED_comms_2fheader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_comms_2fheader_2eproto
...
constexpr Header_Type Header_Type_Type_MIN = Header_Type_COMMAND;
constexpr Header_Type Header_Type_Type_MAX = Header_Type_RESPONSE;
...
enum Header_DataType : int {
  ...
  Header_DataType_Header_DataType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Header_DataType_Header_DataType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool Header_DataType_IsValid(int value);
constexpr Header_DataType Header_DataType_DataType_MIN = Header_DataType_STRING;
constexpr Header_DataType Header_DataType_DataType_MAX = Header_DataType_ENTITY;
constexpr int Header_DataType_DataType_ARRAYSIZE = Header_DataType_DataType_MAX + 1;

const std::string& Header_DataType_Name(Header_DataType value);
template<typename T>
inline const std::string& Header_DataType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Header_DataType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Header_DataType_Name.");
  return Header_DataType_Name(static_cast<Header_DataType>(enum_t_value));
}
...
class Header final :
 ...
 public:
  ...
  static constexpr DataType STRING =
    Header_DataType_STRING;
  static constexpr DataType ENTITY =
    Header_DataType_ENTITY;
  ...
  static inline const std::string& DataType_Name(T enum_t_value) {
    ...
    return Header_DataType_Name(enum_t_value);
  }
...
template <> struct is_proto_enum< ::Header_DataType> : ::std::true_type {};
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_comms_2fheader_2eproto
